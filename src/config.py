...
# Weightss
TRAINED_MODEL_PATH = MODEL_WEIGHTS_DIR / "11-24" / "coffee_model_minilm_fulltext_epoch_finetune_15.pth" #MODEL_WEIGHTS_DIR / "11-12" / "encoder_only_epoch_6_shnm_epoch_2.pth" # None # MODEL_WEIGHTS_DIR / "11-12" / "encoder_only_epoch_6_shnm_epoch_2.pth" #"best_model_weights_only.pth" # switch to none for untrained model #"8-11" / "coffee_model_epoch_11_semi_hard_3.pth"
