...
FAISS_INDEX_PATH = FAISS_DIR / "test.bin"#"faiss_index.bin"
EMBEDDINGS_PATH = EMBEDDINGS_DIR / "test.npy"
TRAINED_MODEL_PATH = MODEL_WEIGHTS_DIR / "best_model_weights_only.pth" # switch to none for untrained model #"8-11" / "coffee_model_epoch_11_semi_hard_3.pth"
